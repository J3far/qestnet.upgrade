...
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.REFERENTIAL_CONSTRAINTS WHERE CONSTRAINT_NAME = 'FK_LTP_StagedTriaxialDetail_LTP')
BEGIN
	ALTER TABLE [dbo].[LTP_StagedTriaxialDetail] WITH CHECK ADD CONSTRAINT [FK_LTP_StagedTriaxialDetail_LTP] FOREIGN KEY(LtpUuid) REFERENCES [dbo].[LTP] ([LtpUuid]) ON UPDATE NO ACTION ON DELETE NO ACTION
END
GO
...
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.REFERENTIAL_CONSTRAINTS WHERE CONSTRAINT_NAME = 'FK_LTP_TriaxialStage_LTP_StagedTriaxialDetail')
BEGIN
	ALTER TABLE [dbo].[LTP_TriaxialStage] WITH CHECK ADD CONSTRAINT [FK_LTP_TriaxialStage_LTP_StagedTriaxialDetail] FOREIGN KEY(StagedTriaxialDetailUUID) REFERENCES [dbo].[LTP_StagedTriaxialDetail] ([QestUUID]) ON UPDATE NO ACTION ON DELETE NO ACTION
END
GO

IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.REFERENTIAL_CONSTRAINTS WHERE CONSTRAINT_NAME = 'FK_LTP_TriaxialStage_LTP_PlannedTest')
BEGIN
	ALTER TABLE [dbo].[LTP_TriaxialStage] WITH CHECK ADD CONSTRAINT [FK_LTP_TriaxialStage_LTP_PlannedTest] FOREIGN KEY(PlannedTestUUID) REFERENCES [dbo].[LTP_PlannedTest] ([PlannedTestUuid]) ON UPDATE NO ACTION ON DELETE NO ACTION
END
GO
...
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.REFERENTIAL_CONSTRAINTS WHERE CONSTRAINT_NAME = 'FK_DocumentConcreteDockets_LaboratoryMapping')
BEGIN
	ALTER TABLE [dbo].[DocumentConcreteDockets] WITH CHECK ADD CONSTRAINT [FK_DocumentConcreteDockets_LaboratoryMapping] FOREIGN KEY([QestOwnerLabNo]) REFERENCES [dbo].[LaboratoryMapping] ([LabNo]) ON UPDATE NO ACTION ON DELETE NO ACTION
END
GO

IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.REFERENTIAL_CONSTRAINTS WHERE CONSTRAINT_NAME = 'FK_DocumentConcreteDockets_qestObject')
BEGIN
	ALTER TABLE [dbo].[DocumentConcreteDockets] WITH CHECK ADD CONSTRAINT [FK_DocumentConcreteDockets_qestObject] FOREIGN KEY([QestID]) REFERENCES [dbo].[qestObject] ([QestID]) ON UPDATE NO ACTION ON DELETE NO ACTION
END
GO
