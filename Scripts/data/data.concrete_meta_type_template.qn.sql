...
DELETE FROM QestSpecimenTypeMetaMap WHERE TemplateName = 'Caltrans CT' OR TemplateQestUniqueID = 18
...
if exists(select 1 from qestViewConfiguration where Active = 1 and Code in ('US', 'Default'))
begin
	exec temp_AddToSpecimenTypeMetaMap 'Caltrans CT', 18, 0, 1602, 'FLEX', 68106
	exec temp_AddToSpecimenTypeMetaMap 'Caltrans CT', 18, 0, 1602, 'FLEXC', 68132
end
