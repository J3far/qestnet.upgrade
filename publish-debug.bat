...
del /Q "\\ADLS0003\Development\Product Distribution\QESTNET.Upgrade\Debug\QESTNET.Upgrade v1.0.1.0.7z"
"C:\Program Files (x86)\7-Zip\7z.exe" a -t7z "\\ADLS0003\Development\Product Distribution\QESTNET.Upgrade\Development\QESTNET.Upgrade v1.0.1.0.7z" ".\temp\*"
